...
namespace XafDemo.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<XafDemoBlazorApplication>(Configuration);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "XafDemo API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the XafDemo.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
