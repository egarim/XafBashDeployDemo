...
namespace XafDemo.WebApi {
    public partial class XafDemoWebApiApplication : BlazorApplication {
        public XafDemoWebApiApplication() {
            InitializeComponent();
        }
        ...
        private void XafDemoWebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
